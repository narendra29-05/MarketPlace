...
builder.Host.ConfigureContainer<ContainerBuilder>(container =>
{
    ...
    {
        cfg.AddMaps(typeof(ApplicationModule).Assembly);       // VendorMappingProfile, ListingMappingProfile
        cfg.AddMaps(typeof(InfrastructureModule).Assembly);    // DbVendorMappingProfile, DbListingMappingProfile
